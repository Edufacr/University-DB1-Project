...
BEGIN TRY
	...
	<conceptocobro id="3" Nombre="Impuesto Propiedad" DiaCobro="8" QDiasVencimiento="12" EsImpuesto="Si" EsRecurrente="Si" EsFijo="No" TasaInteresMoratoria="1.5" TipoCC="CC Porcentaje" Monto="" ValorM3="" ValorPorcentaje="5.0" MontoMinRecibo="" />
	...
	<conceptocobro id="9" Nombre="Acueductos" DiaCobro="7" QDiasVencimiento="6" EsImpuesto="No" EsRecurrente="Si" EsFijo="Si" TasaInteresMoratoria="0.2" TipoCC="CC Fijo" Monto="900" ValorM3="" ValorPorcentaje="" MontoMinRecibo="" />
